...
extension BaseLevel {
    ...
    func updateBotOneImage(){
        if botOneSymbol == 1 {
            caneB1.isHidden = false
            candyB1.isHidden = true
            popB1.isHidden = true
        }
        if botOneSymbol == 2 {
            caneB1.isHidden = true
            candyB1.isHidden = false
            popB1.isHidden = true
        }
        if botOneSymbol == 3 {
            caneB1.isHidden = true
            candyB1.isHidden = true
            popB1.isHidden = false
        }
    }
