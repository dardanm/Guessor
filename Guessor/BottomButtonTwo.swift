...
extension BaseLevel {
    ...
    func updateBotTwoImage(){
        if botTwoSymbol == 1 {
            caneB2.isHidden = false
            candyB2.isHidden = true
            popB2.isHidden = true
        }
        if botTwoSymbol == 2 {
            caneB2.isHidden = true
            candyB2.isHidden = false
            popB2.isHidden = true
        }
        if botTwoSymbol == 3 {
            caneB2.isHidden = true
            candyB2.isHidden = true
            popB2.isHidden = false
        }
    }
