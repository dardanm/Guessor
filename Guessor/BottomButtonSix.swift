...
extension BaseLevel {
    ...
    func updateBotSixImage(){
        if botSixSymbol == 1 {
            caneB6.isHidden = false
            candyB6.isHidden = true
            popB6.isHidden = true
        }
        if botSixSymbol == 2 {
            caneB6.isHidden = true
            candyB6.isHidden = false
            popB6.isHidden = true
        }
        if botSixSymbol == 3 {
            caneB6.isHidden = true
            candyB6.isHidden = true
            popB6.isHidden = false
        }
    }
