...
extension BaseLevel {
    ...
    func updateBotThreeImage(){
        if botThreeSymbol == 1 {
            caneB3.isHidden = false
            candyB3.isHidden = true
            popB3.isHidden = true
        }
        if botThreeSymbol == 2 {
            caneB3.isHidden = true
            candyB3.isHidden = false
            popB3.isHidden = true
        }
        if botThreeSymbol == 3 {
            caneB3.isHidden = true
            candyB3.isHidden = true
            popB3.isHidden = false
        }
    }
