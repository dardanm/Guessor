...
extension BaseLevel {
    ...
    func updateBotSevenImage(){
        if botSevenSymbol == 1 {
            caneB7.isHidden = false
            candyB7.isHidden = true
            popB7.isHidden = true
        }
        if botSevenSymbol == 2 {
            caneB7.isHidden = true
            candyB7.isHidden = false
            popB7.isHidden = true
        }
        if botSevenSymbol == 3 {
            caneB7.isHidden = true
            candyB7.isHidden = true
            popB7.isHidden = false
        }
    }
